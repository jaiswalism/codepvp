...
>
  ...
  {teamA.map((player, idx) => (
    <h1 key={idx} className="text-5xl md:text-6xl font-extrabold text-cyan-400 mb-4 tracking-wide"
  ...
  >
    ...
    {teamB.map((player, idx) => (
        <h1 key={idx} className="text-5xl md:text-6xl font-extrabold text-purple-400 mb-4 tracking-wide"
  ...
  {/* Main Player */}
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div 
          className={`flex items-center justify-center w-36 h-36 md:w-44 md:h-44 rounded-full bg-black border-4 border-gray-800 shadow-[0_0_50px_rgba(0,0,0,1)] transition-all duration-500 ease-out z-10 ${vsStyle}`}
        >
          <span 
            className="text-7xl md:text-8xl font-black italic bg-clip-text text-transparent bg-gradient-to-br from-cyan-400 to-purple-500"
